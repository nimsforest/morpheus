...
// Since we're moving away from named sizes (small/medium/large forest sizes)
// to just specifying node count, this now just returns ProfileSmall
// as the default for all nodes
