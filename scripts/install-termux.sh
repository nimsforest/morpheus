...
echo ""
echo "2. (Optional) Edit config to match your SSH key name:"
echo "   nano ~/.morpheus/config.yaml"
echo "   (Change 'key_name: morpheus' under ssh: to 'key_name: android')"
echo "   Note: Morpheus will auto-detect and upload your SSH key"
echo ""
echo "3. Test Morpheus:"
echo "   morpheus version"
echo ""
echo "4. Create your first forest:"
echo "   morpheus plant cloud small"
echo ""
echo "5. Check status:"
echo "   morpheus list"
echo ""
