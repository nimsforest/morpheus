...
- [ ] Task 1.3 - Add `GetZone` and `ListZones` methods to DNS provider interface (~pkg/dns/interface.go)
- [ ] Task 1.4 - Add zone types to DNS package (~pkg/dns/interface.go)
- [ ] Task 1.5 - Implement zone management in Hetzner DNS provider (~pkg/dns/hetzner/hetzner.go)
...
- [ ] Task 3.1 - Add `morpheus dns zone create` command (~internal/commands/dns_zone.go)
- [ ] Task 3.2 - Add `morpheus dns zone list` command (~internal/commands/dns_zone.go)
- [ ] Task 3.3 - Add `morpheus dns zone delete` command (~internal/commands/dns_zone.go)
- [ ] Task 3.4 - Add `morpheus dns record create` command (~internal/commands/dns_record.go)
- [ ] Task 3.5 - Add `morpheus dns record list` command (~internal/commands/dns_record.go)
- [ ] Task 3.6 - Add `morpheus dns record delete` command (~internal/commands/dns_record.go)
- [ ] Task 3.7 - Add `--customer` flag support to DNS commands (~internal/commands/dns.go)

### Phase 4: Customer Onboarding Automation

- [ ] Task 4.1 - Add `morpheus customer init` command for new customer setup (~internal/commands/customer.go)
- [ ] Task 4.2 - Generate NS record instructions for customer (~pkg/customer/onboarding.go)
- [ ] Task 4.3 - Add zone verification (check NS delegation) (~pkg/dns/verification.go)
- [ ] Task 4.4 - Add `morpheus customer verify` command (~internal/commands/customer.go)

### Phase 5: Venture Service Integration

- [ ] Task 5.1 - Define venture service record templates (~pkg/venture/templates.go)
- [ ] Task 5.2 - Add `morpheus venture enable` command (~internal/commands/venture.go)
- [ ] Task 5.3 - Auto-provision DNS records when venture is enabled (~pkg/venture/provisioner.go)
- [ ] Task 5.4 - Auto-cleanup DNS records when venture is disabled (~pkg/venture/provisioner.go)

### Phase 6: Testing & Documentation

- [ ] Task 6.1 - Unit tests for zone management (~pkg/dns/hetzner/hetzner_test.go)
- [ ] Task 6.2 - Unit tests for customer config (~pkg/customer/config_test.go)
- [ ] Task 6.3 - Integration tests with Hetzner DNS API (~pkg/dns/hetzner/integration_test.go)
- [ ] Task 6.4 - Update main README with DNS management usage (~README.md)
- [ ] Task 6.5 - Add customer onboarding guide (~docs/guides/CUSTOMER_ONBOARDING.md)
