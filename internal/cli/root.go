...
func PrintHelp() {
	...
	fmt.Println()
	fmt.Println("  dns <subcommand>         DNS zone and record management")
	fmt.Println("    zone create <name>     Create a DNS zone")
	fmt.Println("    zone list              List all DNS zones")
	fmt.Println("    zone get <name>        Get zone details")
	fmt.Println("    zone delete <name>     Delete a DNS zone")
	fmt.Println("    record create          Create a DNS record")
	fmt.Println("    record list <zone>     List records in a zone")
	fmt.Println("    record delete          Delete a DNS record")
	fmt.Println()
	...
	fmt.Println("  morpheus customer verify acme  # Check NS delegation")
	fmt.Println()
